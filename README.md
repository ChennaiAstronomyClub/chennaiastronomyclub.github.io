...
**Night Sky Passport challenges** are defined in [`_data/challenges.yml`](_data/challenges.yml) and rendered into the help and catalog pages via Jekyll Liquid includes when the site builds on GitHub Pages.